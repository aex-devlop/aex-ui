...
import AexButtonGroup from 'aex-ui/packages/button-group';
...
export default {
    ...
    watch: {
        ...
        focusing(val) {
            const selfDefine = this.$el.querySelector('.aex-dropdown-selfdefine');
            if (selfDefine) {
                // 自定义
                if (val) {
        ...
        initAria() {
            ...
            if (!this.splitButton) {
                ...
                this.triggerElm.setAttribute(
                    'class',
                    (this.triggerElm.getAttribute('class') || '') + ' aex-dropdown-selfdefine'
                ); // 控制
            }
        },
        initEvent() {
    ...
    render(h) {
        ...
        let triggerElm = !splitButton ? (
            ...
            <aex-button-group>
                <aex-button type={type} size={dropdownSize} nativeOn-click={handleMainButtonClick}>
                    {this.$slots.default}
                </aex-button>
                <aex-button ref='trigger' type={type} size={dropdownSize} class='aex-dropdown__caret-button'>
                    <i class='aex-dropdown__icon aex-icon-down' />
                </aex-button>
            </aex-button-group>
        );

        return (
            <div class='aex-dropdown' v-clickoutside={hide}>
                {triggerElm}
                {this.$slots.dropdown}
            </div>
        );
