...
import AexSelect from 'aex-ui/packages/select';
...
import { valueEquals } from 'aex-ui/src/utils/util';
...
export default {
	...
	render(h) {
		...
		const rightWrapper = <div class="aex-pagination__rightwrapper" />;
	...
	components: {
				...
				return (
					...
					>
						{this.$parent.prevText ? (
							...
							<i class="aex-icon aex-icon-left" />
						)}
					</button>
				);
			}
				...
				return (
					...
					>
						{this.$parent.nextText ? (
							...
							<i class="aex-icon aex-icon-right" />
						)}
					</button>
				);
			}
		...
		Sizes: {
			...
			render(h) {
				return (
					<span class="aex-pagination__sizes">
						<aex-select
						...
						>
							{this.pageSizes.map((item) => (
								<aex-option
									value={item}
									label={
										item + this.t('aex.pagination.pagesize')
									}
								/>
							))}
						</aex-select>
		...
		Jumper: {
			...
			render(h) {
				return (
					<span class="aex-pagination__jump">
						{this.t('aex.pagination.goto')}
						<aex-input
		...
		Total: {
			...
			render(h) {
				return typeof this.$parent.total === 'number' ? (
					<span class="aex-pagination__total">
