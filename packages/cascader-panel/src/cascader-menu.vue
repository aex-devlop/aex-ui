...
export default {
    ...
    methods: {
        ...
        renderEmptyText(h) {
            return <div class='aex-cascader-menu__empty-text'>{this.t('aex.cascader.noData')}</div>;
        },
        renderNodeList(h) {
            const { menuId } = this;
            ...
            return [...nodes, isHoverMenu ? <svg ref='hoverZone' class='aex-cascader-menu__hover-zone' /> : null];
        },
    },
