...
import AexRadio from 'aex-ui/packages/radio';
import { isEqual } from 'aex-ui/src/utils/util';
...
export default {
    ...
    methods: {
        ...
        renderCheckIcon(h) {
            return <i class='aex-icon-check aex-cascader-node__prefix' />;
        },

        renderLoadingIcon(h) {
            return <i class='aex-icon-loading aex-cascader-node__postfix' />;
        },

        renderExpandIcon(h) {
            return <i class='aex-icon-right aex-cascader-node__postfix' />;
        },
        ...
        renderContent(h) {
            ...
            return <span class='aex-cascader-node__label'>{vnode || node.label}</span>;
        },
    },
