...
import Menubar from 'aex-ui/src/utils/menu/aria-menubar';
import { addClass, removeClass, hasClass } from 'aex-ui/src/utils/dom';
...
export default {
  ...
  render (h) {
    const component = (
      <ul
        ...
        class={{
          'aex-menu--horizontal': this.mode === 'horizontal',
          'aex-menu--collapse': this.collapse,
          "aex-menu": true,
      ...
      render(createElement, context) {
        const data = {
          ...
          on: {
            ...
            enter(el) {
              addClass(el, 'aex-opacity-transition');
              el.style.opacity = 1;
            },

            afterEnter(el) {
              removeClass(el, 'aex-opacity-transition');
              el.style.opacity = '';
            },
            ...
            beforeLeave(el) {
              ...
              if (hasClass(el, 'aex-menu--collapse')) {
                removeClass(el, 'aex-menu--collapse');
                el.dataset.oldOverflow = el.style.overflow;
                el.dataset.scrollWidth = el.clientWidth;
                addClass(el, 'aex-menu--collapse');
              } else {
                addClass(el, 'aex-menu--collapse');
                el.dataset.oldOverflow = el.style.overflow;
                el.dataset.scrollWidth = el.clientWidth;
  ...
  watch: {
    ...
    collapse(value) {
      ...
      this.broadcast('AexSubmenu', 'toggle-collapse', value);
    }
  },
  methods: {
