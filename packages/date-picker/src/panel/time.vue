<template>
    <transition name="aex-zoom-in-top" @after-leave="$emit('dodestroy')">
        <div v-show="visible" class="aex-time-panel aex-popper" :class="popperClass">
            <div class="aex-time-panel__content" :class="{ 'has-seconds': showSeconds }">
                <time-spinner
                    ref="spinner"
                    @change="handleChange"
...
import { limitTimeRange, isDate, clearMilliseconds, timeWithinRange } from 'aex-ui/src/utils/date-util';
