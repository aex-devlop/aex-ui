		...
		>
			<div class="aex-picker-panel__body-wrapper">
				...
				<div class="aex-picker-panel__body">
					<div class="aex-date-picker__time-header" v-if="showTime">
						<span class="aex-date-picker__editor-wrap">
							<aex-input
								:placeholder="t('aex.datepicker.selectDate')"
								:value="visibleDate"
								size="small"
					...
					>
						<button
							type="button"
							@click="prevYear"
							:aria-label="t(`aex.datepicker.prevYear`)"
							class="aex-picker-panel__icon-btn aex-date-picker__prev-btn aex-icon-left-double"
						></button>
						<button
							type="button"
							@click="prevMonth"
						...
						<span
							...
							>{{ t(`aex.datepicker.month${month + 1}`) }}</span
						>
						<button
							type="button"
							@click="nextYear"
							:aria-label="t(`aex.datepicker.nextYear`)"
							class="aex-picker-panel__icon-btn aex-date-picker__next-btn aex-icon-right-double"
						></button>
						<button
							type="button"
							@click="nextMonth"
							v-show="currentView === 'date'"
							:aria-label="t(`aex.datepicker.nextMonth`)"
							class="aex-picker-panel__icon-btn aex-date-picker__next-btn aex-icon-right"
						></button>
					</div>

					<div class="aex-picker-panel__content">
						<date-table
							v-show="currentView === 'date'"
							@pick="handleDatePick"
...
export default {
	...
	computed: {
		...
		yearLabel() {
			const yearTranslation = this.t('aex.datepicker.year');
			if (this.currentView === 'year') {
