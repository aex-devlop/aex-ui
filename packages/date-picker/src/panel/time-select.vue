<template>
    <transition name="aex-zoom-in-top" @before-enter="handleMenuEnter" @after-leave="$emit('dodestroy')">
        <div
            ref="popper"
            v-show="visible"
            :style="{ width: width + 'px' }"
            :class="popperClass"
            class="aex-picker-panel time-select aex-popper"
        >
            <aex-scrollbar noresize wrap-class="aex-picker-panel__content">
                <div
...
export default {
    ...
    methods: {
        ...
        scrollToOption(selector = '.selected') {
            const menu = this.$refs.popper.querySelector('.aex-picker-panel__content');
        ...
        handleMenuEnter() {
            ...
            const option =
                (selected && '.selected') || (hasDefault && '.default') || '.time-select-item:not(.disabled)';
