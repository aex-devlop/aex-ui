<template>
    <transition name="aex-zoom-in-top" @after-leave="$emit('dodestroy')">
        <div v-show="visible" class="aex-time-range-picker aex-picker-panel aex-popper" :class="popperClass">
            <div class="aex-time-range-picker__content">
                <div class="aex-time-range-picker__cell">
                    <div class="aex-time-range-picker__header">{{ t('aex.datepicker.startTime') }}</div>
                    <div
                        :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
                        class="aex-time-range-picker__body aex-time-panel__content"
                    >
                        <time-spinner
                            ref="minSpinner"
                ...
                <div class="aex-time-range-picker__cell">
                    <div class="aex-time-range-picker__header">{{ t('aex.datepicker.endTime') }}</div>
                    <div
                        :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
                        class="aex-time-range-picker__body aex-time-panel__content"
                    >
            ...
            <div class="aex-time-panel__footer">
                <button type="button" class="aex-time-panel__btn cancel" @click="handleCancel()">
                    {{ t('aex.datepicker.cancel') }}
                </button>
                <button
                    type="button"
                    class="aex-time-panel__btn confirm"
                    @click="handleConfirm()"
...
import { parseDate, limitTimeRange, modifyDate, clearMilliseconds, timeWithinRange } from 'aex-ui/src/utils/date-util';
