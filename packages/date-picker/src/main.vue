<template>
    <aex-input
        class="aex-date-editor"
        :class="'aex-date-editor--' + type"
        ...
        ref="reference"
    >
        <i slot="prefix" class="aex-input__icon" :class="triggerClass" @click="handleFocus"> </i>
        <i
            slot="suffix"
            class="aex-input__icon"
    ...
    <div
        class="aex-date-editor aex-range-editor aex-input__inner"
        :class="[
            'aex-date-editor--' + type,
            pickerSize ? `aex-range-editor--${pickerSize}` : '',
        ...
        v-else
    >
        <i :class="['aex-input__icon', 'aex-range__icon', triggerClass]"></i>
        <input
            autocomplete="off"
            ...
            @focus="handleFocus"
            class="aex-range-input"
        />
        <slot name="range-separator">
            <span class="aex-range-separator">{{ rangeSeparator }}</span>
        </slot>
        <input
            autocomplete="off"
        ...
        <i
            ...
            v-if="haveTrigger"
            :class="[showClose ? '' + clearIcon : '']"
            class="aex-input__icon aex-range__close-icon"
        >
        </i>
    </div>
</template>
...
import { formatDate, parseDate, isDateObject, getWeekNumber } from 'aex-ui/src/utils/date-util';
