<template>
    <div class="aex-time-spinner" :class="{ 'has-seconds': showSeconds }">
        <template v-if="!arrowControl">
            <aex-scrollbar
                @mouseenter.native="emitSelectRange('hours')"
                @mousemove.native="adjustCurrentSpinner('hours')"
                class="aex-time-spinner__wrapper"
        ...
        <template v-if="arrowControl">
            <div @mouseenter="emitSelectRange('hours')" class="aex-time-spinner__wrapper is-arrow">
                <i v-repeat-click="decrease" class="aex-time-spinner__arrow aex-icon-up"></i>
                <i v-repeat-click="increase" class="aex-time-spinner__arrow aex-icon-down"></i>
                <ul class="aex-time-spinner__list" ref="hours">
                    <li
                        class="aex-time-spinner__item"
            ...
            <div @mouseenter="emitSelectRange('minutes')" class="aex-time-spinner__wrapper is-arrow">
                <i v-repeat-click="decrease" class="aex-time-spinner__arrow aex-icon-up"></i>
                <i v-repeat-click="increase" class="aex-time-spinner__arrow aex-icon-down"></i>
                <ul class="aex-time-spinner__list" ref="minutes">
                    <li
                        class="aex-time-spinner__item"
            ...
            <div @mouseenter="emitSelectRange('seconds')" class="aex-time-spinner__wrapper is-arrow" v-if="showSeconds">
                <i v-repeat-click="decrease" class="aex-time-spinner__arrow aex-icon-up"></i>
                <i v-repeat-click="increase" class="aex-time-spinner__arrow aex-icon-down"></i>
                <ul class="aex-time-spinner__list" ref="seconds">
                    <li
...
import { getRangeHours, getRangeMinutes, modifyTime } from 'aex-ui/src/utils/date-util';
import AexScrollbar from 'aex-ui/packages/scrollbar';
import RepeatClick from 'aex-ui/src/directives/repeat-click';
