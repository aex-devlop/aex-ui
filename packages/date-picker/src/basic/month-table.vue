<template>
    <table @click="handleMonthTableClick" @mousemove="handleMouseMove" class="aex-month-table">
        <tbody>
            <tr v-for="(row, key) in rows" :key="key">
                <td :class="getCellStyle(cell)" v-for="(cell, key) in row" :key="key">
                    <div>
                        <a class="cell">{{ t('aex.datepicker.months.' + months[cell.text]) }}</a>
                    </div>
                </td>
            </tr>
        </tbody>
...
import { isDate, range, getDayCountOfMonth, nextDate } from 'aex-ui/src/utils/date-util';
import { hasClass } from 'aex-ui/src/utils/dom';
import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'aex-ui/src/utils/util';
