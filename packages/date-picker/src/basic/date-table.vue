<template>
    ...
    >
        <tbody>
            <tr>
                <th v-if="showWeekNumber">{{ t('aex.datepicker.week') }}</th>
                <th v-for="(week, key) in WEEKS" :key="key">{{ t('aex.datepicker.weeks.' + week) }}</th>
            </tr>
            <tr
                class="aex-date-table__row"
...
import { arrayFindIndex, arrayFind, coerceTruthyValueToArray } from 'aex-ui/src/utils/util';
