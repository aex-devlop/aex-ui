...
export default {
    ...
    render(h) {
        ...
        const scrollBtn = scrollable
            ? [
                  <span class={['aex-tabs__nav-prev', scrollable.prev ? '' : 'is-disabled']} on-click={scrollPrev}>
                      <i class='aex-icon-left' />
                  </span>,
                  <span class={['aex-tabs__nav-next', scrollable.next ? '' : 'is-disabled']} on-click={scrollNext}>
        ...
        return (
            <div class={['aex-tabs__nav-wrap', scrollable ? 'is-scrollable' : '', `is-${this.rootTabs.tabPosition}`]}>
                {scrollBtn}
                <div class={['aex-tabs__nav-scroll']} ref='navScroll'>
                    <div
                        class={[
                            'aex-tabs__nav',
