    ...
    [
      _c(
        "div",
        {
          ...
          class: ["aex-toast", _vm.customClass],
...
var main_Toast = function Toast(options) {
...
main_Toast.close = function (id, userOnClose) {
...
main_Toast.closeAll = function () {
	for (var i = instances.length - 1; i >= 0; i--) {
		instances[i].close();
	}
};

/* harmony default export */ var src_main = (main_Toast);
