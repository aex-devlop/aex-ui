...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
    ...
    render: function render(h) {
        ...
        var classes = ['aex-tag', type ? 'aex-tag--' + type : '', tagSize ? 'aex-tag--' + tagSize : '', effect ? 'aex-tag--' + effect : '', hit && 'is-hit'];
        var tagEl = h(
            'span',
            ...
            [this.$slots.default, this.closable && h('i', { 'class': 'aex-tag__close aex-icon-close', on: {
