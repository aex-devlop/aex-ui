...
module.exports = require("aex-ui/lib/progress");
...
var upload_listvue_type_template_id_173fedf5_render = function() {
  ...
  return _c(
    "transition-group",
    {
      class: [
        "aex-upload-list",
        "aex-upload-list--" + _vm.listType,
        { "is-disabled": _vm.disabled }
      ],
      attrs: { tag: "ul", name: "aex-list" }
    },
          ...
          _vm._t(
            ...
            [
              ...
              ["picture-card", "picture"].indexOf(_vm.listType) > -1
                ? _c("img", {
                    staticClass: "aex-upload-list__item-thumbnail",
              ...
              _c(
                "a",
                {
                  staticClass: "aex-upload-list__item-name",
                  on: {
                    click: function($event) {
                ...
                [
                  _c("i", { staticClass: "aex-icon-order" }),
                  _vm._v(_vm._s(file.name) + "\n\t\t\t")
                ]
              ),
              _c(
                "label",
                { staticClass: "aex-upload-list__item-status-label" },
                [
                  _c("i", {
                    class: {
                      "aex-icon-upload-success": true,
                      "aex-icon-success": _vm.listType === "text",
                      "aex-icon-check":
                        ["picture-card", "picture"].indexOf(_vm.listType) > -1
                    }
                  })
              ...
              !_vm.disabled
                ...
                : _vm._e(),
              !_vm.disabled
                ? _c("i", { staticClass: "aex-icon-close-tip" }, [
                    _vm._v(_vm._s(_vm.t("aex.upload.deleteTip")))
                  ])
                : _vm._e(),
              file.status === "uploading"
                ? _c("aex-progress", {
              ...
              _vm.listType === "picture-card"
                ? _c("span", { staticClass: "aex-upload-list__item-actions" }, [
                    _vm.handlePreview && _vm.listType === "picture-card"
                      ? _c(
                          "span",
                          {
                            staticClass: "aex-upload-list__item-preview",
                            on: {
                              click: function($event) {
                          ...
                          [_c("i", { staticClass: "aex-icon-zoom-in" })]
                        )
                      : _vm._e(),
                    !_vm.disabled
                      ? _c(
                          "span",
                          {
                            staticClass: "aex-upload-list__item-delete",
                            on: {
                              click: function($event) {
                                _vm.$emit("remove", file)
                              }
                          ...
                          [_c("i", { staticClass: "aex-icon-error" })]
                        )
                      : _vm._e()
                  ])
                : _vm._e()
...
// EXTERNAL MODULE: external "aex-ui/lib/progress"
...
/* harmony default export */ var upload_listvue_type_script_lang_js_ = ({
	...
	components: { AexProgress: progress_default.a },
...
var upload_draggervue_type_template_id_7ebbf219_render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "aex-upload-dragger",
      class: {
...
/* harmony default export */ var uploadvue_type_script_lang_js_ = ({
	...
	render: function render(h) {
		...
		data.class['aex-upload--' + listType] = true;
		return h(
			'div',
				...
				this.uploadFiles = this.uploadFiles.map(function (file) {
					if (!file.url && file.raw) {
						try {
							...
							console.error('[AEXUI Error][Upload]', err);
						}
					}
					return file;
				});
		...
		getMigratingConfig: function getMigratingConfig() {
			return {
				props: {
					...
					'thumbnail-mode': 'thumbnail-mode has been deprecated, you can implement the same effect according to this case: http://aex.uidoc.com/#/components/upload'
				}
			};
		}
	},
