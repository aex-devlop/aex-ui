...
var render = function() {
  ...
  return _c(
    "label",
    {
      staticClass: "aex-radio",
      class: [
        (_vm.border || _vm.checkbox) && _vm.radioSize
          ? "aex-radio--" + _vm.radioSize
          : "",
    ...
    [
      _c(
        ...
        [
          !_vm.checkbox
            ? _c("span", { staticClass: "aex-radio__inner" })
            : _vm._e(),
          _c("input", {
            directives: [
              {
            ...
            ref: "radio",
            staticClass: "aex-radio__original",
            attrs: {
              type: "radio",
              "aria-hidden": "true",
              name: _vm.name,
      ...
      !!_vm.checkbox
        ? _c("span", { staticClass: "aex-radio__checkbox" })
        : _vm._e()
    ]
  )
}
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
    ...
    computed: {
        ...
        radioSize: function radioSize() {
            var temRadioSize = this.size || this._aexFormItemSize || (this.$AEXUI || {}).size;
    ...
    methods: {
        handleChange: function handleChange() {
            ...
            this.$nextTick(function () {
                ...
                _this.isGroup && _this.dispatch('AexRadioGroup', 'handleChange', _this.model);
            });
        }
    }
});
