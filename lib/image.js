      ...
      _vm.loading || !_vm.src
        ? _vm._t("placeholder", [
            _c("div", {
              ...
              staticClass: "aex-icon-img-placeholder aex-image__placeholder"
            })
          ])
        : _vm.error
        ? _vm._t("error", [
            _c(
              "div",
              { staticClass: "aex-image__error", on: { click: _vm.loadImage } },
              [
                _c("span", [_vm._v(_vm._s(_vm.t("aex.image.error")))]),
                _c("i", { staticClass: "aex-icon-refresh-right" })
              ]
            )
          ])
        : _c(
            ...
            _vm._g(
              _vm._b(
                {
                  staticClass: "aex-image__inner",
                  class: {
                    "aex-image__inner--center": _vm.alignCenter,
                    "aex-image__preview": _vm.preview
                  },
...
var image_viewervue_type_template_id_5e73b307_render = function() {
  ...
  return _c("transition", { attrs: { name: "viewer-fade" } }, [
    _c(
      "div",
      {
        ref: "aex-image-viewer__wrapper",
        staticClass: "aex-image-viewer__wrapper",
        style: { "z-index": _vm.viewerZIndex },
        attrs: { tabindex: "-1" }
      },
      [
        _c("div", {
          staticClass: "aex-image-viewer__mask",
          on: {
            click: function($event) {
        ...
        _c(
          "span",
          {
            staticClass: "aex-image-viewer__btn aex-image-viewer__close",
            on: { click: _vm.hide }
          },
          [_c("i", { staticClass: "aex-icon-close" })]
        ),
        !_vm.isSingle
          ? [
              _c(
                "span",
                {
                  staticClass: "aex-image-viewer__btn aex-image-viewer__prev",
                  class: { "is-disabled": !_vm.infinite && _vm.isFirst },
                  on: { click: _vm.prev }
                },
                [_c("i", { staticClass: "aex-icon-left" })]
              ),
              _c(
                "span",
                {
                  staticClass: "aex-image-viewer__btn aex-image-viewer__next",
                  class: { "is-disabled": !_vm.infinite && _vm.isLast },
                  on: { click: _vm.next }
                },
                [_c("i", { staticClass: "aex-icon-right" })]
              )
            ]
          : _vm._e(),
        _c(
          "div",
          { staticClass: "aex-image-viewer__btn aex-image-viewer__actions" },
          [
            _c("div", { staticClass: "aex-image-viewer__actions__inner" }, [
              _c("i", {
                staticClass: "aex-icon-zoom-out",
                on: {
                  click: function($event) {
              ...
              _c("i", { staticClass: "aex-image-viewer__actions__divider" }),
              _c("i", { staticClass: "aex-image-viewer__actions__divider" }),
              _c("i", {
                staticClass: "aex-icon-refresh-left",
                on: {
                  click: function($event) {
              ...
              _c("i", {
                staticClass: "aex-icon-refresh-right",
                on: {
                  click: function($event) {
        ...
        _c(
          "div",
          { staticClass: "aex-image-viewer__canvas" },
          _vm._l(_vm.urlList, function(url, i) {
            return i === _vm.index
              ? _c("img", {
                  ...
                  ref: "img",
                  refInFor: true,
                  staticClass: "aex-image-viewer__img",
                  style: _vm.imgStyle,
...
var Mode = {
	...
	ORIGINAL: {
		name: 'original',
		icon: 'aex-icon-monitoring'
	}
};

var mousewheelEventName = os_["isFirefox"] ? 'DOMMouseScroll' : 'mousewheel';
...
/* harmony default export */ var image_viewervue_type_script_lang_js_ = ({
	...
	mounted: function mounted() {
		...
		this.$refs['aex-image-viewer__wrapper'].focus();
	},
...
var throttle_ = __webpack_require__(23);
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
	...
	methods: {
		...
		handleLoad: function handleLoad(e, img) {
			...
			this.loading = false;
			this.error = false;
			this.$emit('complete', { width: img.width, height: img.height });
		},
