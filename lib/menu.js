...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  render: function render(h) {
    ...
    if (this.collapseTransition) {
      return h('aex-menu-collapse-transition', [component]);
    } else {
      return component;
    }
  },
        ...
        var data = {
          ...
          on: {
            ...
            enter: function enter(el) {
              Object(dom_["addClass"])(el, 'aex-opacity-transition');
              el.style.opacity = 1;
            },
            afterEnter: function afterEnter(el) {
              Object(dom_["removeClass"])(el, 'aex-opacity-transition');
              el.style.opacity = '';
            },
            beforeLeave: function beforeLeave(el) {
              if (!el.dataset) el.dataset = {};

              if (Object(dom_["hasClass"])(el, 'aex-menu--collapse')) {
                Object(dom_["removeClass"])(el, 'aex-menu--collapse');
                el.dataset.oldOverflow = el.style.overflow;
                el.dataset.scrollWidth = el.clientWidth;
                Object(dom_["addClass"])(el, 'aex-menu--collapse');
              } else {
                Object(dom_["addClass"])(el, 'aex-menu--collapse');
                el.dataset.oldOverflow = el.style.overflow;
                el.dataset.scrollWidth = el.clientWidth;
