  ...
  return _c(
    ...
    [
      _c(
        "div",
        {
          staticClass: "aex-carousel__container",
            ...
            ? _c("transition", { attrs: { name: "carousel-arrow-left" } }, [
                _c(
                  "button",
                  {
                    ...
                    staticClass:
                      "aex-carousel__arrow aex-carousel__arrow--left",
                    attrs: { type: "button" },
                    on: {
                      mouseenter: function($event) {
            ...
            ? _c("transition", { attrs: { name: "carousel-arrow-right" } }, [
                _c(
                  "button",
                  {
                    ...
                    staticClass:
                      "aex-carousel__arrow aex-carousel__arrow--right",
                    attrs: { type: "button" },
                    on: {
                      mouseenter: function($event) {
            ...
            _vm._l(_vm.items, function(item, index) {
              return _c(
                "li",
                {
                  key: index,
                  class: [
                    "aex-carousel__indicator",
                    "aex-carousel__indicator--" + _vm.direction,
                ...
                [
                  _c("button", { staticClass: "aex-carousel__button" }, [
                    _vm.hasLabel
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
    ...
    computed: {
        ...
        carouselClasses: function carouselClasses() {
            var classes = ['aex-carousel', 'aex-carousel--' + this.direction];
            if (this.type === 'card') {
                classes.push('aex-carousel--card');
            }
            return classes;
        },
        indicatorsClasses: function indicatorsClasses() {
            var classes = ['aex-carousel__indicators', 'aex-carousel__indicators--' + this.direction];
            if (this.hasLabel) {
                classes.push('aex-carousel__indicators--labels');
            }
            if (this.indicatorPosition === 'outside' || this.type === 'card') {
                classes.push('aex-carousel__indicators--outside');
            }
            return classes;
        }
    },
    ...
    methods: {
        ...
        updateItems: function updateItems() {
            this.items = this.$children.filter(function (child) {
                return child.$options.name === 'AexCarouselItem';
            });
        },
        ...
        setActiveItem: function setActiveItem(index) {
            ...
            if (isNaN(index) || index !== Math.floor(index)) {
                console.warn('[Aex Warn][Carousel]index must be an integer.');
                return;
            }
            var length = this.items.length;
