...
var render = function() {
  ...
  return _c("div", {
    staticClass: "aex-tabs__active-bar",
...
/* harmony default export */ var tab_navvue_type_script_lang_js_ = ({
    ...
    render: function render(h) {
        ...
        var scrollBtn = scrollable ? [h(
            'span',
            { 'class': ['aex-tabs__nav-prev', scrollable.prev ? '' : 'is-disabled'], on: {
                    'click': scrollPrev
                }
            },
            [h('i', { 'class': 'aex-icon-left' })]
        ), h(
            'span',
            { 'class': ['aex-tabs__nav-next', scrollable.next ? '' : 'is-disabled'], on: {
                    'click': scrollNext
                }
            },
            [h('i', { 'class': 'aex-icon-right' })]
        )] : null;
        ...
        return h(
            'div',
            { 'class': ['aex-tabs__nav-wrap', scrollable ? 'is-scrollable' : '', 'is-' + this.rootTabs.tabPosition] },
            [scrollBtn, h(
                'div',
                { 'class': ['aex-tabs__nav-scroll'], ref: 'navScroll' },
                [h(
                    'div',
                    {
                        'class': ['aex-tabs__nav', 'is-' + this.rootTabs.tabPosition, stretch && ['top', 'bottom'].indexOf(this.rootTabs.tabPosition) !== -1 ? 'is-stretch' : ''],
                        ref: 'nav',
                        style: navStyle,
                        attrs: { role: 'tablist'
                        },
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
		...
		calcPaneInstances: function calcPaneInstances() {
			...
			if (this.$slots.default) {
				var paneSlots = this.$slots.default.filter(function (vnode) {
					return vnode.tag && vnode.componentOptions && vnode.componentOptions.Ctor.options.name === 'AexTabPane';
				});
				// update indeed
	...
	render: function render(h) {
		...
		var extraContent = tabPosition == 'top' ? h(
			'div',
			{ 'class': 'aex-tabs__header-extra' },
			[this.$slots.extra]
		) : null;
		var header = h(
			'div',
			{ 'class': ['aex-tabs__header', 'is-' + tabPosition] },
			[extraContent, newButton, h('tab-nav', navData)]
		);
		var panels = h(
			'div',
			{ 'class': 'aex-tabs__content' },
			[this.$slots.default]
		);
		...
		return h(
			'div',
			{
				'class': (_ref2 = {
					'aex-tabs': true,
					'aex-tabs--card': type === 'card'
				}, _ref2['aex-tabs--' + tabPosition] = true, _ref2['aex-tabs--border-card'] = type === 'border-card', _ref2)
			},
...
main_component.options.__file = "packages/tabs/src/main.vue"
...
/* harmony default export */ var tabs = __webpack_exports__["default"] = (main);
