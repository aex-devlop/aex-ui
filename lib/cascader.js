...
module.exports = require("aex-ui/lib/utils/types");
...
module.exports = require("aex-ui/lib/cascader-panel");
...
module.exports = require("aex-ui/lib/locale");
...
var render = function() {
  ...
  return _c(
    "div",
    {
      ...
      class: [
        "aex-cascader",
        _vm.realSize && "aex-cascader--" + _vm.realSize,
    ...
    [
        ...
        [
          _c("template", { slot: "suffix" }, [
            _vm.clearBtnVisible
              ? _c("i", {
                  key: "clear",
                  staticClass: "aex-input__icon aex-icon-error",
                  on: {
      ...
      _vm.multiple
        ? _c(
            "div",
            { staticClass: "aex-cascader__tags" },
            [
              ...
              _vm.filterable && !_vm.isDisabled
                ? _c("input", {
                    ...
                    staticClass: "aex-cascader__search-input",
                    attrs: {
                      type: "text",
        ...
        [
          _c(
            "div",
            {
              ...
              ref: "popper",
              class: ["aex-popper", "aex-cascader__dropdown", _vm.popperClass]
            },
            [
              _c("aex-cascader-panel", {
                directives: [
                  {
                    name: "show",
                    rawName: "v-show",
              ...
              _vm.filterable
                ? _c(
                    "aex-scrollbar",
                    {
                      ...
                      ref: "suggestionPanel",
                      staticClass: "aex-cascader__suggestion-panel",
                      attrs: {
                        tag: "ul",
                        "view-class": "aex-cascader__suggestion-list"
                      },
                      nativeOn: {
                        keydown: function($event) {
                    ...
                    [
                      _vm.suggestions.length
                        ? _vm._l(_vm.suggestions, function(item, index) {
                            return _c(
                              ...
                              [
                                ...
                                item.checked
                                  ? _c("i", { staticClass: "aex-icon-check" })
                                  : _vm._e()
                              ]
                            )
                          })
                        : _vm._t("empty", [
                            _c(
                              "li",
                              { staticClass: "aex-cascader__empty-text" },
                              [_vm._v(_vm._s(_vm.t("aex.cascader.noMatch")))]
                            )
                          ])
                    ],
                    2
...
// EXTERNAL MODULE: external "aex-ui/lib/cascader-panel"
...
// EXTERNAL MODULE: external "aex-ui/lib/locale"
var lib_locale_ = __webpack_require__(44);

// EXTERNAL MODULE: external "aex-ui/lib/utils/util"
var util_ = __webpack_require__(3);

// EXTERNAL MODULE: external "aex-ui/lib/utils/types"
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
    ...
    components: {
        ...
        AexCascaderPanel: cascader_panel_default.a
    },
    ...
    props: {
        ...
        placeholder: {
            ...
            default: function _default() {
                return Object(lib_locale_["t"])('aex.cascader.placeholder');
            }
        },
        disabled: Boolean,
        clearable: Boolean,
    ...
    computed: {
        realSize: function realSize() {
            var _aexFormItemSize = (this.aexFormItem || {}).aexFormItemSize;
            return this.size || _aexFormItemSize || (this.$AEXUI || {}).size;
        },
    ...
    methods: {
        ...
        focusFirstNode: function focusFirstNode() {
            ...
            this.$nextTick(function () {
                ...
                if (filtering && suggestionPanel) {
                    firstNode = suggestionPanel.$el.querySelector('.aex-cascader__suggestion-item');
                } else {
                    var firstMenu = popper.querySelector('.aex-cascader-menu');
                    firstNode = firstMenu.querySelector('.aex-cascader-node[tabindex="-1"]');
                }
        ...
        updateStyle: function updateStyle() {
            ...
            var inputInner = $el.querySelector('.aex-input__inner');

            if (!inputInner) return;

            var tags = $el.querySelector('.aex-cascader__tags');
            var suggestionPanelEl = null;

            if (suggestionPanel && (suggestionPanelEl = suggestionPanel.$el)) {
                var suggestionList = suggestionPanelEl.querySelector('.aex-cascader__suggestion-list');
