    ...
    [
      _c(
        "div",
        {
          ...
          class: [
            "aex-message",
            _vm.type && !_vm.iconClass ? "aex-message--" + _vm.type : "",
        ...
        [
          ...
          _vm._t("default", [
            !_vm.dangerouslyUseHTMLString
              ? _c("p", { staticClass: "aex-message__content" }, [
                  _vm._v(_vm._s(_vm.message))
                ])
              : _c("p", {
                  staticClass: "aex-message__content",
                  domProps: { innerHTML: _vm._s(_vm.message) }
                })
          ]),
          _vm.showClose
            ? _c("i", {
                staticClass: "aex-message__closeBtn aex-icon-close",
                on: { click: _vm.close }
              })
            : _vm._e()
        ],
...
var main_Message = function Message(options) {
	...
	var verticalOffset = options.offset || 66;
