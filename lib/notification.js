...
var render = function() {
  ...
  return _c("transition", { attrs: { name: "aex-notification-fade" } }, [
    _c(
      "div",
      {
        directives: [
        ...
        class: ["aex-notification", _vm.customClass, _vm.horizontalClass],
      ...
      [
        _vm.type || _vm.iconClass
          ? _c("i", {
              staticClass: "aex-notification__icon",
        ...
        _c(
          "div",
          {
            staticClass: "aex-notification__group",
            class: { "is-with-icon": _vm.typeClass || _vm.iconClass }
          },
          [
            _c("h2", {
              staticClass: "aex-notification__title",
            ...
            _c(
              "div",
              {
                ...
                staticClass: "aex-notification__content"
              },
              [
                _vm._t("default", [
            ...
            _vm.showClose
              ? _c("div", {
                  staticClass: "aex-notification__closeBtn aex-icon-close",
                  on: {
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
	...
	computed: {
		typeClass: function typeClass() {
			return this.type && typeMap[this.type] ? 'aex-icon-' + typeMap[this.type] : '';
		},
