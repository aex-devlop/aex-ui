...
var render = function() {
  ...
  return _c("transition", { attrs: { name: "aex-alert-fade" } }, [
    _c(
      "div",
      {
        directives: [
      ...
      [
        _vm.showIcon
          ? _c("i", {
              staticClass: "aex-alert__icon",
              class: [_vm.iconClass, _vm.isBigIcon]
            })
          : _vm._e(),
        _c("div", { staticClass: "aex-alert__content" }, [
          _vm.title || _vm.$slots.title
            ? _c(
                "span",
                { staticClass: "aex-alert__title", class: [_vm.isBoldTitle] },
          ...
          _vm.$slots.default && !_vm.description
            ? _c(
                "p",
                { staticClass: "aex-alert__description" },
                [_vm._t("default")],
                2
              )
            : _vm._e(),
          _vm.description && !_vm.$slots.default
            ? _c("p", { staticClass: "aex-alert__description" }, [
          ...
          _c(
            "i",
            {
              ...
              staticClass: "aex-alert__closebtn",
              class: {
                "is-customed": _vm.closeText !== "",
                "aex-icon-close": _vm.closeText === ""
              },
              on: {
...
var TYPE_CLASSES_MAP = {
	success: 'aex-icon-success',
	warning: 'aex-icon-warning',
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
	...
	computed: {
		typeClass: function typeClass() {
			return 'aex-alert--' + this.type;
		},
		iconClass: function iconClass() {
			return TYPE_CLASSES_MAP[this.type] || 'aex-icon-info';
		},
