...
var render = function() {
  ...
  return _c(
    "div",
    {
      class: [
        "aex-button",
        _vm.buttonSize && "aex-button--" + _vm.buttonSize,
        _vm.type && "aex-button--" + _vm.type,
        {
      ...
      on: {
        click: function($event) {
          !!_vm.isDebounce ? _vm._onClickDebounce() : _vm._onClick()
        }
      }
    },
    [
      _vm.loading ? _c("i", { staticClass: "aex-icon-loading" }) : _vm._e(),
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
	...
	methods: {
		_onClickDebounce: debounce_default()(300, function (e) {
			if (!this.disabled) {
				this.$emit('click', e);
			}
		}),
