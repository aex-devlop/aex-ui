...
var _date = require('aex-ui/lib/utils/date');

var _date2 = _interopRequireDefault(_date);

var _locale = require('aex-ui/lib/locale');
...
var getI18nSettings = exports.getI18nSettings = function getI18nSettings() {
	return {
		dayNamesShort: weeks.map(function (week) {
			return (0, _locale.t)('aex.datepicker.weeks.' + week);
		}),
		dayNames: weeks.map(function (week) {
			return (0, _locale.t)('aex.datepicker.weeks.' + week);
		}),
		monthNamesShort: months.map(function (month) {
			return (0, _locale.t)('aex.datepicker.months.' + month);
		}),
		monthNames: months.map(function (month, index) {
			return (0, _locale.t)('aex.datepicker.month' + (index + 1));
		}),
		amPm: ['am', 'pm']
	};
};
