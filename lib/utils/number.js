...
exports.thousands = exports.zeroize = exports.clearzero = exports.exponentToNumber = undefined;
 ...
 */
var exponentToNumber = exports.exponentToNumber = function exponentToNumber(num) {
	if (isNaN(num)) {
 ...
 * @return {string}
 */
var clearzero = exports.clearzero = function clearzero(number) {
 ...
 * @return {string}
 */
var zeroize = exports.zeroize = function zeroize(number, digits) {
	...
	var _number = exponentToNumber(number);
	...
	return ('' + _number).replace(/(\d+)\.(\d+)/, function (all, $1, $2) {
		var len = digits - $2.length;
		var point = len > 0 ? '' + $2 + (isFill ? '0'.repeat(len) : '') : $2.slice(0, digits);
		return $1 + '.' + point;
	});
};
 ...
 */
var thousands = exports.thousands = function thousands(num, lang) {
	var separator = [',', '.'];
	var _lang = lang || (0, _util.getCookie)('AEX_language');
