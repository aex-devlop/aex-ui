...
var _window = root || {};
var navigator = typeof root.navigator != 'undefined' ? root.navigator : {};
var ua = navigator.userAgent || {};
var isAndroid = exports.isAndroid = !!ua.match(/Android/i);

var isIE = exports.isIE = !isNaN(Number(document.documentMode));

var isEdge = exports.isEdge = ua.indexOf('Edge') > -1;

var isFirefox = exports.isFirefox = !!ua.match(/Firefox/i);

var isChrome = exports.isChrome = !!ua.match(/Chrome|CriOS/i);
var isWindowsPhone = exports.isWindowsPhone = !!ua.match(/Windows Phone/i);
var isSymbian = exports.isSymbian = !!ua.match(/SymbianOS/i) || isWindowsPhone;
var isTablet = exports.isTablet = !!ua.match(/iPad|PlayBook/i) || isAndroid && !ua.match(/Mobile/i) || isFirefox && !!ua.match(/Tablet/i);
var isPhone = exports.isPhone = !!ua.match(/iPhone/i) && !isTablet;

var isPC = exports.isPC = !isPhone && !isAndroid && !isSymbian;
var isMobile = exports.isMobile = !!ua.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i);
