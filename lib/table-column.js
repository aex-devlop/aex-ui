...
var cellStarts = {
    ...
    selection: {
        ...
        realWidth: 48,
        order: '',
        className: 'aex-table-column--selection'
    },
    expand: {
        width: 48,
        minWidth: 48,
...
var cellForced = {
    ...
    expand: {
        ...
        renderCell: function renderCell(h, _ref6) {
            ...
            var classes = ['aex-table__expand-icon'];
            if (store.states.expandRows.indexOf(row) > -1) {
                classes.push('aex-table__expand-icon--expanded');
            }
            ...
            return h(
                ...
                [h('i', { 'class': 'aex-icon aex-icon-right' })]
            );
        },
        sortable: false,
        resizable: false,
        className: 'aex-table__expand-column'
    }
};
...
function treeCellPrefix(h, _ref8) {
    ...
    if (treeNode.indent) {
        ele.push(h('span', { 'class': 'aex-table__indent', style: { 'padding-left': treeNode.indent + 'px' } }));
    }
    if (typeof treeNode.expanded === 'boolean' && !treeNode.noLazyChildren) {
        var expandClasses = ['aex-table__expand-icon', treeNode.expanded ? 'aex-table__expand-icon--expanded' : ''];
        var iconClasses = ['aex-icon-right'];
        if (treeNode.loading) {
            iconClasses = ['aex-icon-loading'];
        }
        ele.push(h(
            'div',
        ...
        ele.push(h('span', { 'class': 'aex-table__placeholder' }));
    }
    return ele;
}
    ...
    methods: {
        ...
        setColumnRenders: function setColumnRenders(column) {
            ...
            if (this.renderHeader) {
                console.warn('[Aex Warn][TableColumn]Comparing to render-header, scoped-slot header is easier to use. We recommend users to use scoped-slot header.');
